...
function createDayElement(day, isOtherMonth, dateStr = null) {
    ...
    if (dateStr && !isOtherMonth) {
        ...
        if (dayData.entries > 0) {
            div.style.border = '1px solid var(--gold-medium)';
        }
...
function renderScreenshots() {
    ...
    filtered.forEach(ss => {
        ...
        div.innerHTML = `
                    ...
                    <div class="screenshot-overlay" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(32, 34, 33, 0.9); display: flex; align-items: center; justify-content: center; opacity: 0; transition: opacity 0.3s;" onclick="viewScreenshot('${ss.id}')">
                        <i class="fas fa-eye" style="color: var(--gold-light); font-size: 1.5rem;"></i>
                    </div>
...
function renderCharts() {
    Chart.defaults.color = '#9A9896';
    Chart.defaults.borderColor = '#303531';
    ...
    new Chart(winRateCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: 'rgba(182, 139, 75, 0.6)',
                borderColor: '#B68B4B',
                borderWidth: 1
            }]
        },
        options: {
            ...
            scales: {
                y: { beginAtZero: true, max: 100, grid: { color: '#303531' } },
    ...
    new Chart(pnlCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: cumulativePnl,
                borderColor: '#B68B4B',
                backgroundColor: 'rgba(182, 139, 75, 0.1)',
                fill: true,
                tension: 0.4
            }]
        },
    ...
    new Chart(monthCtx, {
        ...
        data: {
            ...
            datasets: [{
                ...
                borderColor: Object.values(monthly).map(v => v >= 0 ? '#10b981' : '#ef4444'),
                borderWidth: 1
            }]
        },
        options: {
